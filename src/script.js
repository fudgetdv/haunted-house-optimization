...
const floorColorTexture = textureLoader.load('./floor/mossy_rock_1k/mossy_rock_diff_1k.jpg')
const floorARMTexture = textureLoader.load('./floor/mossy_rock_1k/mossy_rock_arm_1k.jpg')
const floorNormalTexture = textureLoader.load('./floor/mossy_rock_1k/mossy_rock_nor_gl_1k.jpg')
const floorDisplacementTexture = textureLoader.load('./floor/mossy_rock_1k/mossy_rock_disp_1k.jpg')
...
for(let i = 0; i < 20; i++){
    ...
    grave.rotation.x = Math.random() - 0.25
    grave.rotation.y = Math.random() - 0.25
...
directionalLight.shadow.camera.botton = -8
...
//     // 1. Import the exporter (add this at the top of your main .ts file)
// import { GLTFExporter } from 'three/examples/jsm/exporters/GLTFExporter.js'

//     // 2. Create a simple export function
//     function exportToGLB() {
//     const exporter = new GLTFExporter()

//     exporter.parse(
//         scene,                                    // ← your main scene
//         (result) => {
//         // result is an ArrayBuffer when binary: true
//         const blob = new Blob([result as ArrayBuffer], { type: 'application/octet-stream' })
//         const link = document.createElement('a')
//         link.href = URL.createObjectURL(blob)
//         link.download = 'haunted-house-optimized.glb'
//         link.click()
...
//         },
//         {
//         binary: true,           // this gives you .glb instead of .gltf
//         includeCustomExtensions: false
//         }
//     )

//     // 3. Add a keyboard shortcut (press "E" while the scene is running)
//     window.addEventListener('keydown', (event) => {
//     if (event.key.toLowerCase() === 'e') {
//         exportToGLB()
//         console.log('✅ Exporting scene as haunted-house-optimized.glb...')
//     }
//     })
